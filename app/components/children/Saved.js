...
// Create a "Saved" component for saved articles.
var Saved = React.createClass({
    ...
    componentWillReceiveProps: function(nextProps) {
        ...
        var myResults = nextProps.savedArticles.map(function(search, i) {
            ...
            key = { i } > < a href = { search.url } target = "_blank" > { search.title } < /a><br / > { search.date } < br / > < button type = "button"
        ...
        return (
            ...
            <div className = "panel panel-success">
            	...
            	<div className = "panel-body">
            		{ /* Here we use a map function to loop through an array in JSX*/} { this.state.savedArticles } 
	            </div> 
            </div>
        )
    }
